  ...
  _createClass(Grapick, [{
    ...
    value: function setValue() {
      ...
      values.forEach(function (value) {
        ...
        _this2.addHandler(position, color, 0, options);
      });
      this.updatePreview();
    }
    ...
    value: function addHandler(position, color) {
      ...
      var handler = new _Handler2.default(this, position, color, select);
    ...
    value: function initEvents() {
      ...
      pEl && (0, _utils.on)(pEl, 'click', function (e) {
        ...
        self.getHandlers().forEach(function (h) {
        ...
        self.addHandler(percentage, color);
      });
    }
...
var Handler = function () {
  ...
  _createClass(Handler, [{
    ...
    value: function initEvents() {
      ...
      colorEl && (0, _utils.on)(colorEl, 'change', function (e) {
        var target = e.target;
      ...
      if (dragEl) {
        ...
        var drag = function drag(e) {
          ...
          deltaPos.x = x - startPos.x;
          deltaPos.y = x - startPos.y;
			 // /ARJAN
          ...
          pos = pos < min ? min : pos;
          pos = pos > max ? max : pos;
          _this.setPosition(pos, 0);
          _this.emit('handler:drag', _this, pos);
          // In case the mouse button was released outside of the window
          //e.which === 0 && _stopDrag(e); // ARJAN removed this
        };

        /* ARJAN: Improved this function, see below
        var _stopDrag = function _stopDrag(e) {
          ...
          _this.emit('handler:drag:end', _this, pos);
        };
		  */
        ...
        var initDrag = function initDrag(e) {
          ...
          _this.select();
          posInit = _this.position;
          elDim.w = previewEl.clientWidth;
          elDim.h = previewEl.clientHeight;

          //startPos.x = e.clientX;
          //startPos.y = e.clientY;
			 startPos.x = e.touches ? e.touches[0].clientX : e.clientX; // ARJAN
			 startPos.y = e.touches ? e.touches[0].clientY : e.clientY; // ARJAN

          (0, _utils.on)(document, eventMove, drag);
          (0, _utils.on)(document, eventUp, _stopDrag);
          _this.emit('handler:drag:start', _this);
        };
